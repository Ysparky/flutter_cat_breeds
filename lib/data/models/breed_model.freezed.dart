...
mixin _$BreedModel {
 ...
 WeightModel get weight; String get id; String get name; String get temperament; String get origin;@JsonKey(name: 'country_codes') String get countryCodes;@JsonKey(name: 'country_code') String get countryCode; String get description;@JsonKey(name: 'life_span') String get lifeSpan; int get indoor; int get adaptability;@JsonKey(name: 'affection_level') int get affectionLevel;@JsonKey(name: 'child_friendly') int get childFriendly;@JsonKey(name: 'dog_friendly') int get dogFriendly;@JsonKey(name: 'energy_level') int get energyLevel; int get grooming;@JsonKey(name: 'health_issues') int get healthIssues; int get intelligence;@JsonKey(name: 'shedding_level') int get sheddingLevel;@JsonKey(name: 'social_needs') int get socialNeeds;@JsonKey(name: 'stranger_friendly') int get strangerFriendly; int get vocalisation; int get experimental; int get hairless; int get natural; int get rare; int get rex;@JsonKey(name: 'suppressed_tail') int get suppressedTail;@JsonKey(name: 'short_legs') int get shortLegs; int get hypoallergenic;@JsonKey(name: 'reference_image_id') String get referenceImageId;@JsonKey(name: 'cfa_url') String? get cfaUrl;@JsonKey(name: 'vetstreet_url') String? get vetstreetUrl;@JsonKey(name: 'vcahospitals_url') String? get vcahospitalsUrl;@JsonKey(name: 'alt_names') String? get altNames;@JsonKey(name: 'wikipedia_url') String? get wikipediaUrl; int? get lap;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,weight,id,name,temperament,origin,countryCodes,countryCode,description,lifeSpan,indoor,adaptability,affectionLevel,childFriendly,dogFriendly,energyLevel,grooming,healthIssues,intelligence,sheddingLevel,socialNeeds,strangerFriendly,vocalisation,experimental,hairless,natural,rare,rex,suppressedTail,shortLegs,hypoallergenic,referenceImageId,cfaUrl,vetstreetUrl,vcahospitalsUrl,altNames,wikipediaUrl,lap]);

@override
String toString() {
  return 'BreedModel(weight: $weight, id: $id, name: $name, temperament: $temperament, origin: $origin, countryCodes: $countryCodes, countryCode: $countryCode, description: $description, lifeSpan: $lifeSpan, indoor: $indoor, adaptability: $adaptability, affectionLevel: $affectionLevel, childFriendly: $childFriendly, dogFriendly: $dogFriendly, energyLevel: $energyLevel, grooming: $grooming, healthIssues: $healthIssues, intelligence: $intelligence, sheddingLevel: $sheddingLevel, socialNeeds: $socialNeeds, strangerFriendly: $strangerFriendly, vocalisation: $vocalisation, experimental: $experimental, hairless: $hairless, natural: $natural, rare: $rare, rex: $rex, suppressedTail: $suppressedTail, shortLegs: $shortLegs, hypoallergenic: $hypoallergenic, referenceImageId: $referenceImageId, cfaUrl: $cfaUrl, vetstreetUrl: $vetstreetUrl, vcahospitalsUrl: $vcahospitalsUrl, altNames: $altNames, wikipediaUrl: $wikipediaUrl, lap: $lap)';
}
...
@useResult
$Res call({
 WeightModel weight, String id, String name, String temperament, String origin,@JsonKey(name: 'country_codes') String countryCodes,@JsonKey(name: 'country_code') String countryCode, String description,@JsonKey(name: 'life_span') String lifeSpan, int indoor, int adaptability,@JsonKey(name: 'affection_level') int affectionLevel,@JsonKey(name: 'child_friendly') int childFriendly,@JsonKey(name: 'dog_friendly') int dogFriendly,@JsonKey(name: 'energy_level') int energyLevel, int grooming,@JsonKey(name: 'health_issues') int healthIssues, int intelligence,@JsonKey(name: 'shedding_level') int sheddingLevel,@JsonKey(name: 'social_needs') int socialNeeds,@JsonKey(name: 'stranger_friendly') int strangerFriendly, int vocalisation, int experimental, int hairless, int natural, int rare, int rex,@JsonKey(name: 'suppressed_tail') int suppressedTail,@JsonKey(name: 'short_legs') int shortLegs, int hypoallergenic,@JsonKey(name: 'reference_image_id') String referenceImageId,@JsonKey(name: 'cfa_url') String? cfaUrl,@JsonKey(name: 'vetstreet_url') String? vetstreetUrl,@JsonKey(name: 'vcahospitals_url') String? vcahospitalsUrl,@JsonKey(name: 'alt_names') String? altNames,@JsonKey(name: 'wikipedia_url') String? wikipediaUrl, int? lap
});
...
/// Create a copy of BreedModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? weight = null,Object? id = null,Object? name = null,Object? temperament = null,Object? origin = null,Object? countryCodes = null,Object? countryCode = null,Object? description = null,Object? lifeSpan = null,Object? indoor = null,Object? adaptability = null,Object? affectionLevel = null,Object? childFriendly = null,Object? dogFriendly = null,Object? energyLevel = null,Object? grooming = null,Object? healthIssues = null,Object? intelligence = null,Object? sheddingLevel = null,Object? socialNeeds = null,Object? strangerFriendly = null,Object? vocalisation = null,Object? experimental = null,Object? hairless = null,Object? natural = null,Object? rare = null,Object? rex = null,Object? suppressedTail = null,Object? shortLegs = null,Object? hypoallergenic = null,Object? referenceImageId = null,Object? cfaUrl = freezed,Object? vetstreetUrl = freezed,Object? vcahospitalsUrl = freezed,Object? altNames = freezed,Object? wikipediaUrl = freezed,Object? lap = freezed,}) {
...
class _BreedModel implements BreedModel {
  const _BreedModel({required this.weight, required this.id, required this.name, required this.temperament, required this.origin, @JsonKey(name: 'country_codes') required this.countryCodes, @JsonKey(name: 'country_code') required this.countryCode, required this.description, @JsonKey(name: 'life_span') required this.lifeSpan, required this.indoor, required this.adaptability, @JsonKey(name: 'affection_level') required this.affectionLevel, @JsonKey(name: 'child_friendly') required this.childFriendly, @JsonKey(name: 'dog_friendly') required this.dogFriendly, @JsonKey(name: 'energy_level') required this.energyLevel, required this.grooming, @JsonKey(name: 'health_issues') required this.healthIssues, required this.intelligence, @JsonKey(name: 'shedding_level') required this.sheddingLevel, @JsonKey(name: 'social_needs') required this.socialNeeds, @JsonKey(name: 'stranger_friendly') required this.strangerFriendly, required this.vocalisation, required this.experimental, required this.hairless, required this.natural, required this.rare, required this.rex, @JsonKey(name: 'suppressed_tail') required this.suppressedTail, @JsonKey(name: 'short_legs') required this.shortLegs, required this.hypoallergenic, @JsonKey(name: 'reference_image_id') required this.referenceImageId, @JsonKey(name: 'cfa_url') this.cfaUrl, @JsonKey(name: 'vetstreet_url') this.vetstreetUrl, @JsonKey(name: 'vcahospitals_url') this.vcahospitalsUrl, @JsonKey(name: 'alt_names') this.altNames, @JsonKey(name: 'wikipedia_url') this.wikipediaUrl, this.lap});
...
/// Create a copy of BreedModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? weight = null,Object? id = null,Object? name = null,Object? temperament = null,Object? origin = null,Object? countryCodes = null,Object? countryCode = null,Object? description = null,Object? lifeSpan = null,Object? indoor = null,Object? adaptability = null,Object? affectionLevel = null,Object? childFriendly = null,Object? dogFriendly = null,Object? energyLevel = null,Object? grooming = null,Object? healthIssues = null,Object? intelligence = null,Object? sheddingLevel = null,Object? socialNeeds = null,Object? strangerFriendly = null,Object? vocalisation = null,Object? experimental = null,Object? hairless = null,Object? natural = null,Object? rare = null,Object? rex = null,Object? suppressedTail = null,Object? shortLegs = null,Object? hypoallergenic = null,Object? referenceImageId = null,Object? cfaUrl = freezed,Object? vetstreetUrl = freezed,Object? vcahospitalsUrl = freezed,Object? altNames = freezed,Object? wikipediaUrl = freezed,Object? lap = freezed,}) {
